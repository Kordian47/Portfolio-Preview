...
const projectDetails: Record<string, { problem: string; solution: string; result: string }> = {
  ...
  "beam-deflection-calculator": {
    problem: "Hand calculations of beam shear, moment, slope, and deflection are time-consuming, error-prone, and impractical for complex or mixed loading conditions.",
    solution: "Developed a numerical beam analysis tool using Euler–Bernoulli beam theory, static equilibrium, LU decomposition, and numerical integration to compute shear, moment, slope, and deflection for arbitrary loading scenarios.",
    result: "Produced physically correct response diagrams that match analytical solutions in shape and magnitude, while remaining extensible to more complex structural analysis problems.",
  },
};
